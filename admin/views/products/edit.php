...
<section class="container" style="margin-top: 6em !important;">
    ...
    <form action="change.php" method="POST" enctype="multipart/form-data">
        <input type="hidden" name="item_id" class="form-control" placeholder="Name" value="<?php echo isset($item_id) ? $item_id : '' ?>">
        ...
        <div class="form-group row mt-4">
            ...
            <div class="col-md-6">
                ...
                <img id="img" src="<?php echo isset($image) ? $image : '' ?>" class="pt-3 hide" alt="1.png" height="100px" width="auto" style="box-shadow: rgba(0, 0, 0, 0.1) 0px 10px 15px -3px, rgba(0, 0, 0, 0.05) 0px 4px 6px -2px;">
            </div>
            <script>
